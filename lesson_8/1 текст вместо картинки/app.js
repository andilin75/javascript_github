...
function handleClick(clickedButtonEvent) { // 2. из объекта события получите ссылку на .product и сохраните в переменную:
    ...
    let button_text = card.button.innerText; // 4. получаем текст на кнопке, которая внутри .product
...
function showMoreText(card) {
    ...
    let text = 'Произвольный текст';  //6.1 сохраняем произвольный текст в переменную
